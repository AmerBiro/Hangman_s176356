package com.example.hangman_s176356.database;
...
public class Player extends SQLiteOpenHelper {
    ...
    public void createPlayer(String playerName, String playerBirthDate, int playerScore){
    ...
    public void updateScore(String row_id, String playerScore){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_PAGES, playerScore);
